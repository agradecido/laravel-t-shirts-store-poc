...
CREATE TABLE `colors` (
  ...
  `rgb` varchar(6) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`slug`),
  UNIQUE KEY `colors_name_unique` (`name`),
  UNIQUE KEY `colors_rgb_unique` (`rgb`)
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2024_01_22_190704_create_colors_table',2);
